...
const it = {
  ...
  story: {
    ...
    cardValue: "1500+",
    imageAlt:
      "Mappa del mondo con le principali borse monitorate: NYSE, NASDAQ, LSE, JPX, SSE ed Euronext",
  },
  pricing: {
    overline: "Prezzi",
    ...
    plans: [
      {
        ...
        features: [
          "News: solo gli articoli di oggi",
          "Stock Snapshot: 1 al giorno",
        ],
        locked: [
          "Learning",
          "Report finanziari",
          "Pianificatore finanze personali",
        ],
        cta: "Inizia gratis",
        note: "",
      },
      {
        tagline: "Tutti gli strumenti per decidere",
        features: [
          "News illimitate + archivio completo",
          "Stock Snapshot: 3 al giorno",
          "Report finanziari: bilanci 10-K + indicatori completi",
          "Pianificatore finanze: crea ed esporta il bilancio",
        ],
        locked: [
          "Learning (solo con Unlimited)",
        ],
        cta: "Passa a Premium",
        note: "Prezzo di lancio (primi 10.000) · poi €7,99/mese",
      },
      {
        tagline: "Tutto sbloccato, incluso Learning",
        features: [
          "Tutto il piano Premium",
          "Stock Snapshot: 7 al giorno",
          "Learning: 28 lezioni (azioni, obbligazioni, crypto, forex, materie prime e altro)",
        ],
        locked: [],
        cta: "Passa a Unlimited",
        note: "Prezzo di lancio (primi 10.000) · poi €9,99/mese",
      },
    ],
  },
  contact: {
  ...
  // Pagina /contatti: recapiti di assistenza e dati della società editrice.
  contactPage: {
    overline: "Assistenza",
    title: "Contatti",
    subtitle: "Rispondiamo alle richieste di assistenza sull'app Finzy.",
    detailsTitle: "Recapiti",
    emailLabel: "Email",
    phoneLabel: "Telefono",
    responseLabel: "Tempi di risposta",
    responseValue: "Entro 2 giorni lavorativi",
    publisherTitle: "Società editrice",
    legalNameLabel: "Ragione sociale",
    addressLabel: "Sede legale",
    vatLabel: "Partita IVA",
    registrationLabel: "Numero di iscrizione",
...
const en: Dict = {
  ...
  story: {
    ...
    cardValue: "1500+",
    imageAlt:
      "World map with the main monitored exchanges: NYSE, NASDAQ, LSE, JPX, SSE and Euronext",
  },
  pricing: {
    overline: "Pricing",
    ...
    plans: [
      {
        ...
        features: [
          "News: today's articles only",
          "Stock Snapshot: 1 per day",
        ],
        locked: [
          "Learning",
          "Financial reports",
      ...
      {
        tagline: "Every tool to decide with clarity",
        features: [
          "News: unlimited + full archive",
          "Stock Snapshot: 3 per day",
          "Financial reports: 10-K statements + full indicators",
          "Personal Finance planner: build + export balance sheet",
        ],
        locked: [
          "Learning (Unlimited only)",
        ],
        cta: "Get Premium",
        note: "Launch price (first 10,000) · then €7.99/mo",
      },
      {
        tagline: "Everything unlocked, Learning included",
        features: [
          "Everything in Premium",
          "Stock Snapshot: 7 per day",
          "Learning: 28 lessons (stocks, bonds, crypto, forex, commodities and more)",
        ],
        locked: [],
        cta: "Get Unlimited",
        note: "Launch price (first 10,000) · then €9.99/mo",
      },
    ],
  },
  contact: {
  ...
  contactPage: {
    overline: "Support",
    title: "Contact",
    subtitle: "We answer support requests about the Finzy app.",
...
const es: Dict = {
  ...
  story: {
    ...
    cardValue: "1500+",
    imageAlt:
      "Mapa del mundo con las principales bolsas monitoreadas: NYSE, NASDAQ, LSE, JPX, SSE y Euronext",
  },
  pricing: {
    overline: "Precios",
    ...
    plans: [
      {
        ...
        features: [
          "Noticias: solo los artículos de hoy",
          "Stock Snapshot: 1 al día",
        ],
        locked: [
          "Learning",
      ...
      {
        tagline: "Todas las herramientas para decidir",
        features: [
          "Noticias: ilimitadas + archivo completo",
          "Stock Snapshot: 3 al día",
          "Informes financieros: balances 10-K + indicadores completos",
          "Planificador de finanzas: crea y exporta el balance",
        ],
        locked: [
          "Learning (solo con Unlimited)",
        ],
        cta: "Hazte Premium",
        note: "Precio de lanzamiento (primeros 10.000) · luego €7,99/mes",
      },
      {
        tagline: "Todo desbloqueado, Learning incluido",
        features: [
          "Todo el plan Premium",
          "Stock Snapshot: 7 al día",
          "Learning: 28 lecciones (acciones, bonos, cripto, forex, materias primas y más)",
        ],
        locked: [],
        cta: "Hazte Unlimited",
        note: "Precio de lanzamiento (primeros 10.000) · luego €9,99/mes",
      },
    ],
  },
  contact: {
  ...
  contactPage: {
    overline: "Soporte",
    title: "Contacto",
    subtitle: "Respondemos a las solicitudes de soporte sobre la app Finzy.",
    detailsTitle: "Datos de contacto",
    emailLabel: "Email",
    phoneLabel: "Teléfono",
    responseLabel: "Tiempo de respuesta",
    responseValue: "En un plazo de 2 días laborables",
    publisherTitle: "Empresa editora",
    legalNameLabel: "Razón social",
    addressLabel: "Domicilio social",
    vatLabel: "Número de IVA",
    registrationLabel: "Número de registro mercantil",
...
const fr: Dict = {
  ...
  story: {
    ...
    cardValue: "1500+",
    imageAlt:
      "Carte du monde avec les principales bourses suivies : NYSE, NASDAQ, LSE, JPX, SSE et Euronext",
  },
  pricing: {
    overline: "Tarifs",
    ...
    plans: [
      {
        ...
        features: [
          "News : uniquement les articles du jour",
          "Stock Snapshot : 1 par jour",
        ],
        locked: [
          "Learning",
          "Rapports financiers",
          "Planificateur de finances personnelles",
        ],
        cta: "Commencer gratuitement",
        note: "",
      },
      {
        tagline: "Tous les outils pour décider",
        features: [
          "News : illimitées + archives complètes",
          "Stock Snapshot : 3 par jour",
          "Rapports financiers : bilans 10-K + indicateurs complets",
          "Planificateur de finances : créez et exportez le bilan",
        ],
        locked: [
          "Learning (Unlimited uniquement)",
        ],
        cta: "Passer à Premium",
        note: "Prix de lancement (10 000 premiers) · puis 7,99 €/mois",
      },
      {
        tagline: "Tout débloqué, Learning inclus",
        features: [
          "Tout le plan Premium",
          "Stock Snapshot : 7 par jour",
          "Learning : 28 leçons (actions, obligations, crypto, forex, matières premières et plus)",
        ],
        locked: [],
        cta: "Passer à Unlimited",
        note: "Prix de lancement (10 000 premiers) · puis 9,99 €/mois",
      },
    ],
  },
  contact: {
  ...
  contactPage: {
    ...
    title: "Contact",
    subtitle:
      "Nous répondons aux demandes d'assistance concernant l'application Finzy.",
    detailsTitle: "Coordonnées",
    emailLabel: "E-mail",
    phoneLabel: "Téléphone",
    responseLabel: "Délai de réponse",
    responseValue: "Sous 2 jours ouvrés",
    publisherTitle: "Société éditrice",
...
const pt: Dict = {
  ...
  story: {
    ...
    cardValue: "1500+",
    imageAlt:
      "Mapa-múndi com as principais bolsas monitorizadas: NYSE, NASDAQ, LSE, JPX, SSE e Euronext",
  },
  pricing: {
    overline: "Preços",
    ...
    plans: [
      {
        ...
        features: [
          "Notícias: apenas os artigos de hoje",
          "Stock Snapshot: 1 por dia",
        ],
        locked: [
          "Learning",
          "Relatórios financeiros",
          "Planeador de finanças pessoais",
        ],
        cta: "Começar grátis",
        note: "",
      },
      {
        tagline: "Todas as ferramentas para decidir",
        features: [
          "Notícias: ilimitadas + arquivo completo",
          "Stock Snapshot: 3 por dia",
          "Relatórios financeiros: balanços 10-K + indicadores completos",
          "Planeador de finanças: cria e exporta o balanço",
        ],
        locked: [
          "Learning (só com Unlimited)",
        ],
        cta: "Mudar para Premium",
        note: "Preço de lançamento (primeiros 10.000) · depois €7,99/mês",
      },
      {
        tagline: "Tudo desbloqueado, Learning incluído",
        features: [
          "Tudo do plano Premium",
          "Stock Snapshot: 7 por dia",
          "Learning: 28 lições (ações, obrigações, cripto, forex, matérias-primas e mais)",
        ],
        locked: [],
        cta: "Mudar para Unlimited",
        note: "Preço de lançamento (primeiros 10.000) · depois €9,99/mês",
      },
    ],
  },
  contact: {
  ...
  contactPage: {
    overline: "Apoio",
    title: "Contacto",
    subtitle: "Respondemos aos pedidos de apoio sobre a app Finzy.",
    detailsTitle: "Dados de contacto",
    emailLabel: "Email",
    phoneLabel: "Telefone",
    responseLabel: "Tempo de resposta",
    responseValue: "Até 2 dias úteis",
    publisherTitle: "Empresa editora",
    legalNameLabel: "Denominação social",
